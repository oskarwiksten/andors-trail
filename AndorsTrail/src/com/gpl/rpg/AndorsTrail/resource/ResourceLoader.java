...
public final class ResourceLoader {
	...
	private static void prepareTilesets(DynamicTileLoader loader, int mTileSize) {
		...
		loader.prepareTileset(R.drawable.map_bridge_2, "map_bridge_2.png", src_mapTileSize, defaultTileSize);
		...
		loader.prepareTileset(R.drawable.map_cavewall_4, "map_cavewall_4.png", new Size(18, 6), defaultTileSize);
		loader.prepareTileset(R.drawable.map_chair_table_1, "map_chair_table_1.png", src_mapTileSize, defaultTileSize);
		loader.prepareTileset(R.drawable.map_chair_table_2, "map_chair_table_2.png", src_mapTileSize, defaultTileSize);
		...
		loader.prepareTileset(R.drawable.map_entrance_2, "map_entrance_2.png", src_mapTileSize, defaultTileSize);
		...
		loader.prepareTileset(R.drawable.map_fence_3, "map_fence_3.png", src_mapTileSize, defaultTileSize);
		loader.prepareTileset(R.drawable.map_fence_4, "map_fence_4.png", src_mapTileSize, defaultTileSize);
		...
		loader.prepareTileset(R.drawable.map_house_1, "map_house_1.png", src_mapTileSize, defaultTileSize);
		loader.prepareTileset(R.drawable.map_house_2, "map_house_2.png", src_mapTileSize, defaultTileSize);
		loader.prepareTileset(R.drawable.map_indoor_1, "map_indoor_1.png", src_mapTileSize, defaultTileSize);
		loader.prepareTileset(R.drawable.map_indoor_2, "map_indoor_2.png", src_mapTileSize, defaultTileSize);
		...
		loader.prepareTileset(R.drawable.map_pillar_2, "map_pillar_2.png", src_mapTileSize, defaultTileSize);
		loader.prepareTileset(R.drawable.map_plant_1, "map_plant_1.png", src_mapTileSize, defaultTileSize);
		loader.prepareTileset(R.drawable.map_plant_2, "map_plant_2.png", src_mapTileSize, defaultTileSize);
		loader.prepareTileset(R.drawable.map_rock_1, "map_rock_1.png", src_mapTileSize, defaultTileSize);
		loader.prepareTileset(R.drawable.map_rock_2, "map_rock_2.png", src_mapTileSize, defaultTileSize);
		...
		loader.prepareTileset(R.drawable.map_roof_3, "map_roof_3.png", src_mapTileSize, defaultTileSize);
		...
		loader.prepareTileset(R.drawable.map_transition_1, "map_transition_1.png", src_mapTileSize, defaultTileSize);
		loader.prepareTileset(R.drawable.map_transition_2, "map_transition_2.png", src_mapTileSize, defaultTileSize);
		loader.prepareTileset(R.drawable.map_transition_3, "map_transition_3.png", src_mapTileSize, defaultTileSize);
		loader.prepareTileset(R.drawable.map_transition_4, "map_transition_4.png", src_mapTileSize, defaultTileSize);
		loader.prepareTileset(R.drawable.map_tree_1, "map_tree_1.png", src_mapTileSize, defaultTileSize);
		loader.prepareTileset(R.drawable.map_tree_2, "map_tree_2.png", src_mapTileSize, defaultTileSize);
		...
		loader.prepareTileset(R.drawable.map_wall_4, "map_wall_4.png", new Size(15, 8), defaultTileSize);
