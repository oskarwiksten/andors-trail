...
public final class Constants {
	...
	public static int rollValue(final Range r) { return rollValue(r.getMax(), r.getCurrent()); }
	...
	public static boolean rollResult(final Range r) { return rollResult(r.getMax(), r.getCurrent()); }
