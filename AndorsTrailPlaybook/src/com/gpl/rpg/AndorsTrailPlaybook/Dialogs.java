...
import com.gpl.rpg.AndorsTrailPlaybook.activity.*;
...
import com.gpl.rpg.AndorsTrailPlaybook.model.ability.ActorConditionType;
import com.gpl.rpg.AndorsTrailPlaybook.model.ability.SkillCollection;
import com.gpl.rpg.AndorsTrailPlaybook.model.actor.Monster;
import com.gpl.rpg.AndorsTrailPlaybook.model.item.Inventory;
import com.gpl.rpg.AndorsTrailPlaybook.model.item.ItemType;
import com.gpl.rpg.AndorsTrailPlaybook.model.item.Loot;
import com.gpl.rpg.AndorsTrailPlaybook.model.map.MapObject;
import com.gpl.rpg.AndorsTrailPlaybook.resource.tiles.TileManager;
import com.gpl.rpg.AndorsTrailPlaybook.view.ItemContainerAdapter;
...
public final class Dialogs {
	...
	public static void showConversation(final MainActivity currentActivity, final ControllerContext context, final String phraseID, final Monster npc) {
		...
		intent.setData(Uri.parse("content://com.gpl.rpg.AndorsTrailPlaybook/conversation/" + phraseID));
	...
	public static void showMonsterEncounter(final MainActivity currentActivity, final ControllerContext context, final Monster monster) {
		...
		intent.setData(Uri.parse("content://com.gpl.rpg.AndorsTrailPlaybook/monsterencounter"));
	...
	public static void showMonsterInfo(final Context context, final Monster monster) {
		...
		intent.setData(Uri.parse("content://com.gpl.rpg.AndorsTrailPlaybook/monsterinfo"));
		addMonsterIdentifiers(intent, monster);
	...
	public static Intent getIntentForItemInfo(final Context ctx, String itemTypeID, ItemInfoActivity.ItemInfoAction actionType, String buttonText, boolean buttonEnabled, Inventory.WearSlot inventorySlot) {
		...
		intent.setData(Uri.parse("content://com.gpl.rpg.AndorsTrailPlaybook/iteminfo/" + itemTypeID));
		return intent;
	}
	public static Intent getIntentForLevelUp(final Context ctx) {
		Intent intent = new Intent(ctx, LevelUpActivity.class);
		intent.setData(Uri.parse("content://com.gpl.rpg.AndorsTrailPlaybook/levelup"));
		return intent;
	}
	...
	public static boolean showSave(final Activity mainActivity, final ControllerContext controllerContext, final WorldContext world) {
		...
		intent.setData(Uri.parse("content://com.gpl.rpg.AndorsTrailPlaybook/save"));
	...
	public static void showLoad(final Activity currentActivity) {
		...
		intent.setData(Uri.parse("content://com.gpl.rpg.AndorsTrailPlaybook/load"));
	...
	public static void showActorConditionInfo(final Context context, ActorConditionType conditionType) {
		...
		intent.setData(Uri.parse("content://com.gpl.rpg.AndorsTrailPlaybook/actorconditioninfo/" + conditionType.conditionTypeID));
		context.startActivity(intent);
	}
	...
	private static Intent getIntentForBulkSelectionInterface(final Context ctx, String itemTypeID, int totalAvailableAmount, BulkSelectionInterface.BulkInterfaceType interfaceType) {
		...
		intent.setData(Uri.parse("content://com.gpl.rpg.AndorsTrailPlaybook/bulkselection/" + itemTypeID));
		return intent;
	}
	public static Intent getIntentForSkillInfo(final Context ctx, SkillCollection.SkillID skillID) {
		...
		intent.setData(Uri.parse("content://com.gpl.rpg.AndorsTrailPlaybook/showskillinfo/" + skillID));
		return intent;
	}
